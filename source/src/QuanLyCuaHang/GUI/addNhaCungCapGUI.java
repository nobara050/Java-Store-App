...
public class addNhaCungCapGUI extends javax.swing.JFrame {

    NhaCungCapBUS nccBUS = new NhaCungCapBUS();
    public boolean flag = false;
    
    public addNhaCungCapGUI() {
        initComponents();
    ...
    private void jBLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBLuuActionPerformed
        ...
        flag = nccBUS.addNhaCungCap(jTTenNCC.getText(),jTDiaChi.getText(),jTMaNCC.getText());
        if (flag == true) {
                NhaCungCapGUI.AddRowToJTable(new Object[]{
                    jTTenNCC.getText(),
                    jTDiaChi.getText(),
                    jTMaNCC.getText()
                });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addNhaCungCapGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new addNhaCungCapGUI().setVisible(true);
            }
        });
    }
